...
I love being out in the field. I've been out taking core samples, sampling heavy metals in streams, freshwater invertebrates, invasive fish, lake chemistry, aphids, flowering plants, and setting audio recorders and camera traps. Click on any image for slideshow with more photos.

::: {.photo-grid}
![Biodiversity surveys and wetland coring in New Zealand](images/fieldwork-nz.jpg){.photo group="fieldwork"}

![Post-fire recovery fieldwork in Alaska](images/fieldwork-ak.jpg){.photo group="fieldwork"}

![Agricultural fieldwork in the US](images/fieldwork-arlington.jpeg){.photo group="fieldwork"}
:::
...
::: {.lightbox-only}
![Black spruce, Alaska](images/fieldwork-ak-spruce.jpg){.photo group="fieldwork"}

![Deciduous regrowth after fire, Alaska](images/fieldwork-ak-decid.jpg){.photo group="fieldwork"}

![Cone collection, Alaska](images/fieldwork-ak-cones.jpg){.photo group="fieldwork"}
:::
