---
title: Statistical analyses of community and palaeoecological time series to identify environmental drivers and biotic interactions
date: "2026-07-13"
...
We recently [published a new state-space modelling approach for analysing community time series data](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210x.70315). This model was developed during my postdoc at UW-Madison with Tony Ives and Jack Williams.

A [blog post accompanying the publication](https://methodsblog.com/2026/07/13/from-pattern-to-process-estimating-species-interactions-and-driver-species-relationships-from-count-data/) includes links to all the newest resources!

I gave a talk for Methods in Ecology and Evolution, and the recording will be available on the MEE [YouTube channel](https://www.youtube.com/@MethodsEcolEvol/videos) soon. The resources from the talk are [available at this repository](https://quinnasena.github.io/multinomialTS-workshop-MEE/).


Below is an older post from when we were developing the model, kept here for context:
