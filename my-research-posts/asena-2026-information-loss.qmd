---
title: Information loss in palaeoecological data from process and observer error
date: "2026-04-10"
image: "images/asena-2026-information-loss/walk_step_fisher_two_dim_metrics_mean_plot.png"
aliases:
  - /my-research-posts/asena-2024b.html
categories:
  - Ecology
  - Modelling
  - Virtual Ecology
...
![Mean Euclidean distance from the ‘error-free’ core of two treatments combined calculated across replicate simulations for Fisher’s information. The mixing axis shows the number of time-steps over which mixing occurs. Along the sub-sampling axis, the frequency of sub-sampling in centimetres is shown, and the proxy counting axis displays count resolutions in number of individuals counted per sample. In the proxy counting treatment, uncertainty increases as count resolution decreases.](images/asena-2026-information-loss/walk_step_fisher_two_dim_metrics_mean_plot.png){#fig-twoD}
