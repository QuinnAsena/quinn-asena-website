...
![The `multinomialTS` workflow: preparing state variables and covariates, the decisions to make about grouping taxa, interpolating covariates and choosing a prediction resolution, then fitting and comparing competing hypotheses.](workshops-lectures-posts/images/flowchart1.png)
